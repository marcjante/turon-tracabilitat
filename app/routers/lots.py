...
from app.services.lots import afegir_consum_manual, anular_consum, anular_lot, cercar_lots_per_codi, obtenir_lot
...
def obtenir(lot_id: int, session: Session = Depends(get_session)):
    return obtenir_lot(session, lot_id)
